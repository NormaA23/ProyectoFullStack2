...
class Catalogo: 
    recetas = []
    #   Agregar recetas 
    def agregar_receta(self, codigo, nombre, descripcion, imagen,ingredientes, procedimiento): 
        if self.consultar_receta(codigo): 
            return False 
        nueva_receta = { 
            'codigo': codigo, 
            'nombre': nombre,
...
""" catalogo.consultar_receta(2) """ 
""" catalogo.listar_receta() """
""" catalogo.agregar_receta(4, "hola", "hola", "hola", "hola", "hola" ) """
